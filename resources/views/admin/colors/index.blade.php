            ...
            <div class="conatiner-fluid mx-3">
                <div class="row d-flex justify-content-center mb-3">
                    <form action="{{ url('/admin/colors') }}" method="POST">
                        ...
                        <input type="text" id="name" name="name" placeholder="Enter color Name" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form style="display: inline" class="mx-2"
                                            action="{{ url('/admin/colors/' . $color['id']) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                onclick="return confirm('Delete this color, Are you sure?')"
